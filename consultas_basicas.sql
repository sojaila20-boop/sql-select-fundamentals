...
-- Autor: Sojaila Contreras
-- Fecha: 23/08/2026
-- Motor: SQL Server
-- ══════════════════════════════════════════

IF DB_ID('SQL_Select_Fundamentals') IS NULL
    CREATE DATABASE SQL_Select_Fundamentals;
GO

USE SQL_Select_Fundamentals;
GO
...
-- SELECT * es útil para explorar una tabla completa durante el análisis inicial.
-- En producción conviene evitarlo porque puede traer columnas innecesarias y afectar el rendimiento.
